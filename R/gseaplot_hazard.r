...
#' @param pvalue_table Whether to add pvalue_table
#' @return Plot of gene set enrichment on Hazard Ratio-ranked gene sets.
#' @export
#'
#' @examples
#' library(HazardGeneEnrichment)
#' #my_gsea_results is result of gseaplot_hazard.r
...
gseaplot_hazard<-function (x, geneSetID, title = "", color = "green", base_size = 11,
  ...
  p.pos <- p.pos + ylab("LogRazardRatio") + xlab("Rank in Ordered Dataset") +
